# 🗄️ Configuración de Base de Datos - PetAlert

## 📋 Resumen de lo que necesitas hacer

Sí, necesitas configurar varias cosas importantes en la base de datos para que la aplicación funcione correctamente. Aquí tienes la guía completa:
...
2. Copia estos valores:
   ...
   - **service_role key**: `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...` (¡MANTÉN ESTA SECRETA!)
...
EXPO_PUBLIC_SUPABASE_ANON_KEY=tu-clave-anonima-real-aqui

# Supabase Configuration (Backend)
SUPABASE_URL=https://tu-proyecto-id.supabase.co
SUPABASE_SERVICE_KEY=tu-clave-service-role-real-aqui
...
ALLOWED_ORIGINS=http://localhost:8081,http://127.0.0.1:8081,exp://192.168.0.204:8081
```

## 🗃️ Paso 4: Crear las Tablas en Supabase

Ve a **SQL Editor** en tu dashboard de Supabase y ejecuta este script completo:

```sql
-- ==============================================
-- ESQUEMA DE BASE DE DATOS PARA PETALERT
-- ==============================================
...
2. Verifica que se crearon estos buckets:
...
3. Intenta crear un reporte para verificar que todo funciona.

## 🚨 Solución de Problemas Comunes

### Error: "relation does not exist"
- **Causa**: Las tablas no se crearon correctamente
- **Solución**: Ejecuta el script SQL completo de nuevo
...
- **Causa**: Los buckets de storage no se crearon
- **Solución**: Ve a Storage y crea manualmente los buckets

### La app sigue usando datos mock
- **Causa**: Variables de entorno incorrectas
- **Solución**: Verifica que el archivo `.env` tiene las credenciales correctas

## 📊 Monitoreo

Una vez configurado, puedes monitorear tu aplicación en:
- **Dashboard**: Supabase → Dashboard → Tables
- **Logs**: Supabase → Logs
- **Storage**: Supabase → Storage

## 🎉 ¡Listo!

Con estos pasos, tu aplicación PetAlert debería funcionar completamente con una base de datos real. Los usuarios podrán:
